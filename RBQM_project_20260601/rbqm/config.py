...
NEW_KRI_LABELS = {
    ...
    "bmi_under_24_rate": "BMI<24比例",
    "bmi_30_35_rate": "BMI 30-35比例",
    "bmi_over_35_count": "BMI>35病例数",
    ...
    "hba1c_missing_rate": "HbA1c数据缺失受试者比例",
    "weight_missing_rate": "体重数据缺失受试者比例",
    "concomitant_event_rate": "伴发事件受试者比例",
    "early_termination_rate": "W44前提前退出受试者比例",
    "pregnancy_rate": "妊娠受试者比例",
    "data_consistency_issue_days": "数据一致性问题未解决天数",
}
...
NEW_COMPONENT_LABELS = {
    ...
    "Efficacy Completeness_component": "疗效数据完整性评分",
    "Subject Retention_component": "受试者留存评分",
    "Safety Reporting_component": "安全性/事件评分",
    "Data Consistency_component": "数据一致性评分",
    "MM Baseline Balance_component": "MM基线特征评分",
}
